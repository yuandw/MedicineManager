...
<html:html locale="true">
  <head>
    <title><bean:message key="system.customer_info.manage.view"/></title>
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0"
			...
			<tr>
				<td class="td_title1">
					...
					&gt;&gt; <bean:message key="system.customer_info.manage.view"/>
				</td>
      ...
      <table border="1" align="center" width="500" cellpadding="1" cellspacing="1" bgcolor="#036500" bordercolor="#FFFFF">
        <tr bgcolor="#FFFFFF">
         <td class="tb_tl"><bean:message key="user.id"/></td>
          <td class="tb_tl"><bean:message key="customer.customerno"/></td>
          <td class="tb_tl"><bean:message key="customer.customername"/></td>
          <td class="tb_tl"><bean:message key="customer.contactperson"/></td>
          <td class="tb_tl"><bean:message key="customer.contacttel"/></td>
          <td class="tb_tl"><bean:message key="customer.contactaddress"/></td>
          <td class="tb_tl"><bean:message key="customer.remark"/></td>
        	...
        	<logic:notEmpty name="list" scope="request">
	        	<logic:iterate id="ele" name="list" scope="request">
	        		...
	        		<td><bean:write name="ele" property="id"/></td>
	        			<td><bean:write name="ele" property="customerno"/></td>
	        			<td>
	        				<bean:write name="ele" property="customername"/>
	        			</td>
	        			<td>
	        			...
	        			<td>
	        				<html:link href="../system/customer.do?command=customerDelete" paramId="id" paramName="ele" paramProperty="id">
